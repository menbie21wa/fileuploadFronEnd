            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
                <div>
                  ...
                  />
                  {errors.email && (
                    <p className="text-red-500">{translate("checkIsValidEmail")}</p>
                  )}
                </div>
                <div>
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-start">
                    <div class="flex items-center h-5">
                      <input id="remember" aria-describedby="remember" type="checkbox" class="w-4 h-4 border border-gray-300
                    ...
                    <div class="ml-3 text-sm">
                      <label for="remember" class="text-gray-500 dark:text-gray-300">{translate("remember")}</label>
                    </div>
                  </div>
                  <a href="#" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">{translate("forgotPassword")}</a>
                </div>
                {loading ? (
                  <button
                    disabled
                  ...
                  <button
                   ...
                   dark:hover:bg-blue-700 dark:focus:ring-blue-800">{translate("login")}</button>
                )}
                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                  {translate("doNotHaveAnAccount")} <a href="#" class="font-medium text-blue-600 hover:underline dark:text-blue-500">{translate("createAnAccount")}</a>
                </p>
              </form>
            </div>
          </div>
